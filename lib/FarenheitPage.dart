...
class FarenheitPage extends StatefulWidget{

  FarenheitPage({this.result});

  final String result;


  _FarenheitPage createState() =>  _FarenheitPage(result);

}



class  _FarenheitPage extends State<FarenheitPage> {
  ...
  String convert_state="imperial";
  String set_text="°F";

  _FarenheitPage(this. result);
